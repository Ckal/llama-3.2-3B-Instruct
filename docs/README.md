...
- URL: https://huggingface.co/spaces/Chris4K/llama-3.2-3B-Instruct
- SDK: gradio
...
1. **Private Monorepo** (development)
   - Location: `apps/huggingface/llama-3.2-3B-Instruct/`
   - All development happens here
   - Contains secrets and private configuration

2. **Public GitHub Repository**
   - URL: https://github.com/Ckal/llama-3.2-3B-Instruct
